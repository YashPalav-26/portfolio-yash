...
const HeroSection = ({ onSectionClick }: HeroSectionProps) => {
  ...
  return (
    ...
    >
      <div className="max-w-screen-xl px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <Reveal delay={0.1}>
            <h3 className="text-1xl md:text-3xl font-bold text-muted-foreground mb-8 h-12 flex items-center justify-center md:justify-start">
